...
- **Track F ML pipeline (CLI):** features → L2 logistic (optional sklearn HGB) → temperature ensemble → EV annotate feeding `MODEL_PROBABILITY_EDGE` (`make ml-e2e`; stdlib default, no live feeds)
