...
> **Current tip** (post-merge continuum): see [PRODUCTION_READINESS_CONTINUUM_2026-08-04.md](PRODUCTION_READINESS_CONTINUUM_2026-08-04.md) (`aa89903`, package 0.3.0). Gate table below is the **PR #3 foundation** pin.
